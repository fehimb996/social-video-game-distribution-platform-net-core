...
namespace DrustvenaPlatformaVideoIgara.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(SteamContext context)
        {
            _context = context;
        }
        ...
        {
            var steamContext = _context.Reviews.Include(r => r.Product).Include(r => r.User);
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,UserId,ProductId,Rating,Comment")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,UserId,ProductId,Rating,Comment")] Review review)
        {
