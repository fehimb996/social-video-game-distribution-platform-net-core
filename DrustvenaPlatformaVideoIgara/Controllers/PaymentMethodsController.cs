...
namespace DrustvenaPlatformaVideoIgara.Controllers
{
    public class PaymentMethodsController : Controller
    {
        ...
        public PaymentMethodsController(SteamContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PaymentMethodId,Method")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentMethodId,Method")] PaymentMethod paymentMethod)
        {
